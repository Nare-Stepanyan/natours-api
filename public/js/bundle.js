...
exports.dipslayMap = void 0;

var dipslayMap = function dipslayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFyLWRldiIsImEiOiJja3l1NTNjYnEwNzQ4MnNwbnB5MDExMGhpIn0.Cm4Ky4vhGgfy8kIMH-uabQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/nar-dev/ckyu5har9001f15phybui0d02',
    zoom: 9
  });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3001/api/v1/users/updateMyPassword' : 'http://localhost:3001/api/v1/users/updateCurrentUser';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KNbc3LjyatOwj1NuzWblAhiL0rG7tom5xGVFmGQ30alWGvTqaVDM15nnmwesDK5ogmHYEAbwwosusukegGEPmMi00Ztz9uf0w');
            _context.prev = 1;
            _context.next = 4;
